package com.appweava.androidstarter.presentation.debugdrawer;

import android.content.Intent;

import com.appweava.androidstarter.presentation.base.IntentFactory;
import com.appweava.androidstarter.presentation.debugdrawer.ui.ExternalIntentActivity;
...
public final class DebugIntentFactory implements IntentFactory {
    ...
    public Intent createUrlIntent(String url) {
        ...
        if (!isMockMode || !captureIntents.get()) {
            ...
            return ExternalIntentActivity.getCallingIntent(baseIntent);
        }
    }
}
